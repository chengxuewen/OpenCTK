...
TEST(ColorSpace, TestSettingPrimariesFromUint8)
{
    ...
    EXPECT_TRUE(color_space.set_primaries_from_uint8(static_cast<uint8_t>(ColorSpace::PrimaryID::kBT470BG)));
...
{
    ColorSpace color_space;
    EXPECT_TRUE(color_space.set_transfer_from_uint8(static_cast<uint8_t>(ColorSpace::TransferID::kBT2020_10)));
...
{
    ColorSpace color_space;
    EXPECT_TRUE(color_space.set_matrix_from_uint8(static_cast<uint8_t>(ColorSpace::MatrixID::kCDNCLS)));
...
{
    ColorSpace color_space;
    EXPECT_TRUE(color_space.set_range_from_uint8(static_cast<uint8_t>(ColorSpace::RangeID::kFull)));
