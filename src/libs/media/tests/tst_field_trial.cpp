...
{
#if GTEST_HAS_DEATH_TEST && OCTK_DCHECK_IS_ON && !defined(OCTK_OS_ANDROID) &&                                          \
...
{
    // Bad delimiters
    RTC_EXPECT_DEATH(InitFieldTrialsFromString("Audio/EnabledVideo/Disabled/"), "Invalid field trials string:");
    RTC_EXPECT_DEATH(InitFieldTrialsFromString("Audio/Enabled//Video/Disabled/"), "Invalid field trials string:");
    RTC_EXPECT_DEATH(InitFieldTrialsFromString("/Audio/Enabled/Video/Disabled/"), "Invalid field trials string:");
    RTC_EXPECT_DEATH(InitFieldTrialsFromString("Audio/Enabled/Video/Disabled"), "Invalid field trials string:");
    RTC_EXPECT_DEATH(InitFieldTrialsFromString("Audio/Enabled/Video/Disabled/garbage"), "Invalid field trials string:");
    ...
    EXPECT_FALSE(FieldTrialsStringIsValid("/Audio/Enabled/Video/Disabled/"));
    EXPECT_FALSE(FieldTrialsStringIsValid("Audio/Enabled/Video/Disabled"));
    EXPECT_FALSE(FieldTrialsStringIsValid("Audio/Enabled/Video/Disabled/garbage"));

    // Empty trial or group
    RTC_EXPECT_DEATH(InitFieldTrialsFromString("Audio//"), "Invalid field trials string:");
    RTC_EXPECT_DEATH(InitFieldTrialsFromString("/Enabled/"), "Invalid field trials string:");
    RTC_EXPECT_DEATH(InitFieldTrialsFromString("//"), "Invalid field trials string:");
    RTC_EXPECT_DEATH(InitFieldTrialsFromString("//Enabled"), "Invalid field trials string:");
    ...
    RTC_EXPECT_DEATH(InitFieldTrialsFromString("Audio/Enabled/Audio/Disabled/"), "Invalid field trials string:");
    RTC_EXPECT_DEATH(InitFieldTrialsFromString("Audio/Enabled/B/C/Audio/Disabled/"), "Invalid field trials string:");
...
{
    EXPECT_EQ(MergeFieldTrialsStrings("Video/Enabled/", "Audio/Enabled/"), "Audio/Enabled/Video/Enabled/");
    EXPECT_EQ(MergeFieldTrialsStrings("Audio/Disabled/Video/Enabled/", "Audio/Enabled/"),
              "Audio/Enabled/Video/Enabled/");
    EXPECT_EQ(MergeFieldTrialsStrings("Audio/Enabled/Video/Enabled/", "Audio/Enabled/"),
              "Audio/Enabled/Video/Enabled/");
    EXPECT_EQ(MergeFieldTrialsStrings("Audio/Enabled/Audio/Enabled/", "Video/Enabled/"),
              "Audio/Enabled/Video/Enabled/");
}

TEST(FieldTrialMergingDeathTest, DchecksBadInput)
{
    RTC_EXPECT_DEATH(MergeFieldTrialsStrings("Audio/Enabled/", "garbage"), "Invalid field trials string:");
}
...
#endif // GTEST_HAS_DEATH_TEST && RTC_DCHECK_IS_ON && !defined(OCTK_OS_ANDROID)
       // && !defined(WEBRTC_EXCLUDE_FIELD_TRIAL_DEFAULT)
