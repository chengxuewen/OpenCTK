...
TEST(RateControlSettingsTest, CongestionWindow)
{
    ...
    const RateControlSettings settings = ParseFrom("WebRTC-CongestionWindow/QueueSize:100/");
...
TEST(RateControlSettingsTest, CongestionWindowPushback)
{
    ...
    const RateControlSettings settings = ParseFrom("WebRTC-CongestionWindow/QueueSize:100,MinBitrate:100000/");
...
TEST(RateControlSettingsTest, CongestionWindowPushbackDropframe)
{
    ...
    const RateControlSettings settings = ParseFrom("WebRTC-CongestionWindow/"
...
TEST(RateControlSettingsTest, PacingFactor)
{
    ...
    EXPECT_THAT(ParseFrom("WebRTC-VideoRateControl/pacing_factor:1.2/").GetPacingFactor(), Optional(DoubleEq(1.2)));
}
...
TEST(RateControlSettingsTest, AlrProbing)
{
    ...
    EXPECT_TRUE(ParseFrom("WebRTC-VideoRateControl/alr_probing:1/").UseAlrProbing());
}
...
TEST(RateControlSettingsTest, LibvpxVp8QpMax)
{
    ...
    EXPECT_EQ(ParseFrom("WebRTC-VideoRateControl/vp8_qp_max:50/").LibvpxVp8QpMax(), 50);
}

TEST(RateControlSettingsTest, DoesNotGetTooLargeLibvpxVp8QpMaxValue)
{
    EXPECT_FALSE(ParseFrom("WebRTC-VideoRateControl/vp8_qp_max:70/").LibvpxVp8QpMax());
}
...
TEST(RateControlSettingsTest, LibvpxVp8MinPixels)
{
    ...
    EXPECT_EQ(ParseFrom("WebRTC-VideoRateControl/vp8_min_pixels:50000/").LibvpxVp8MinPixels(), 50000);
}

TEST(RateControlSettingsTest, DoesNotGetTooSmallLibvpxVp8MinPixelValue)
{
    EXPECT_FALSE(ParseFrom("WebRTC-VideoRateControl/vp8_min_pixels:0/").LibvpxVp8MinPixels());
}
...
TEST(RateControlSettingsTest, LibvpxTrustedRateController)
{
    ...
    const RateControlSettings settings = ParseFrom("WebRTC-VideoRateControl/trust_vp8:0,trust_vp9:0/");
...
TEST(RateControlSettingsTest, Vp8BaseHeavyTl3RateAllocationLegacyKey)
{
    ...
    EXPECT_TRUE(ParseFrom("WebRTC-UseBaseHeavyVP8TL3RateAllocation/Enabled/").Vp8BaseHeavyTl3RateAllocation());
}

TEST(RateControlSettingsTest, Vp8BaseHeavyTl3RateAllocationVideoRateControlKey)
{
    EXPECT_FALSE(ParseFrom("").Vp8BaseHeavyTl3RateAllocation());

    EXPECT_TRUE(ParseFrom("WebRTC-VideoRateControl/vp8_base_heavy_tl3_alloc:1/").Vp8BaseHeavyTl3RateAllocation());
}

TEST(RateControlSettingsTest, Vp8BaseHeavyTl3RateAllocationVideoRateControlKeyOverridesLegacyKey)
{
    EXPECT_FALSE(ParseFrom("").Vp8BaseHeavyTl3RateAllocation());
...
TEST(RateControlSettingsTest, UseEncoderBitrateAdjuster)
{
    ...
    EXPECT_FALSE(ParseFrom("WebRTC-VideoRateControl/bitrate_adjuster:false/").UseEncoderBitrateAdjuster());
}
