...
OCTK_MEDIA_API const char *ResourceUsageStateToString(ResourceUsageState usage_state);

class OCTK_MEDIA_API ResourceListener
{
public:
...
class OCTK_MEDIA_API Resource : public RefCountInterface
{
public:
    Resource();
