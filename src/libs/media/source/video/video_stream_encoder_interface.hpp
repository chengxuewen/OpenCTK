...
#include <openctk/media/video_layers_allocation.hpp>
#include <openctk/media/fec_controller_override.hpp>
#include <openctk/media/video_source_interface.hpp>
#include <openctk/media/video_encoder_config.hpp>
#include <openctk/media/video_sink_interface.hpp>
#include <openctk/media/rtp_sender_interface.hpp>
#include <openctk/media/rtp_parameters.hpp>
#include <openctk/media/encoded_image.hpp>
#include <openctk/media/video_encoder.hpp>
// #include <openctk/media/scoped_refptr.hpp>
#include <openctk/core/data_rate.hpp>
#include <openctk/media/resource.hpp>
...
public:
    ...
    {
    public:
        virtual void OnEncoderConfigurationChanged(std::vector<VideoStream> streams,
                                                   bool is_svc,
        ...
        virtual void OnVideoLayersAllocationUpdated(VideoLayersAllocation allocation) = 0;
    };
    ...
    virtual void SetSource(VideoSourceInterface<VideoFrame> *source,
    ...
    virtual void OnLossNotification(const VideoEncoder::LossNotification &loss_notification) = 0;
    ...
    virtual void SetFecControllerOverride(FecControllerOverride *fec_controller_override) = 0;
    ...
    virtual void ConfigureEncoder(VideoEncoderConfig config, size_t max_data_payload_length) = 0;
    virtual void
    ConfigureEncoder(VideoEncoderConfig config, size_t max_data_payload_length, SetParametersCallback callback) = 0;
