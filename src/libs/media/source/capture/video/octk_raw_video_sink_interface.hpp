...
#ifndef _OCTK_VIDEO_CAPTURE_RAW_VIDEO_SINK_INTERFACE_H_
#define _OCTK_VIDEO_CAPTURE_RAW_VIDEO_SINK_INTERFACE_H_
...
#endif  // _OCTK_VIDEO_CAPTURE_RAW_VIDEO_SINK_INTERFACE_H_
