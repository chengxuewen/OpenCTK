...
#import <octk_camera_video_capturer_mac.hpp>
...
@interface RTC_OBJC_TYPE (MacCameraVideoCapturer)
...
@implementation RTC_OBJC_TYPE (MacCameraVideoCapturer)
{
...
- (void)dealloc {
    NSAssert(!_willBeRunning,
             @"Session was still running in RTC_OBJC_TYPE(MacCameraVideoCapturer) dealloc. Forgot to "
             @"call stopCapture?");
