...
#ifndef _OCTK_VIDEO_CAPTURE_VIDEO_CAPTURE_FACTORY_H_
#define _OCTK_VIDEO_CAPTURE_VIDEO_CAPTURE_FACTORY_H_
...
#endif  // _OCTK_VIDEO_CAPTURE_VIDEO_CAPTURE_FACTORY_H_
