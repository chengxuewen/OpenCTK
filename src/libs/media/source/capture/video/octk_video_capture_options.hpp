 ...
 */
#ifndef _OCTK_VIDEO_CAPTURE_VIDEO_CAPTURE_OPTIONS_H_
#define _OCTK_VIDEO_CAPTURE_VIDEO_CAPTURE_OPTIONS_H_
...
class RTC_EXPORT VideoCaptureOptions {
 public:
  ...
  std::shared_ptr<videocapturemodule::PipeWireSession> pipewire_session();
#endif
 ...
 private:
  ...
  std::shared_ptr<videocapturemodule::PipeWireSession> pipewire_session_;
#endif
};

}  // namespace webrtc

#endif  // _OCTK_VIDEO_CAPTURE_VIDEO_CAPTURE_OPTIONS_H_
