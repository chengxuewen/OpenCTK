...
#ifndef _OCTK_VIDEO_CAPTURE_VIDEO_CAPTURE_H_
#define _OCTK_VIDEO_CAPTURE_VIDEO_CAPTURE_H_
...
public:
    ...
    virtual void RegisterCaptureDataCallback(RawVideoSinkInterface *dataCallback) = 0;
...
#endif // _OCTK_VIDEO_CAPTURE_VIDEO_CAPTURE_H_
