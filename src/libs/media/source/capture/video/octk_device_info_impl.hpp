...
#ifndef _OCTK_VIDEO_CAPTURE_MAIN_SOURCE_DEVICE_INFO_IMPL_H_
#define _OCTK_VIDEO_CAPTURE_MAIN_SOURCE_DEVICE_INFO_IMPL_H_
...
class DeviceInfoImpl : public VideoCaptureModule::DeviceInfo {
 ...
 protected:
  ...
  VideoCaptureCapabilities _captureCapabilities OCTK_ATTRIBUTE_GUARDED_BY(_apiLock);
  Mutex _apiLock;
  char* _lastUsedDeviceName OCTK_ATTRIBUTE_GUARDED_BY(_apiLock);
  uint32_t _lastUsedDeviceNameLength OCTK_ATTRIBUTE_GUARDED_BY(_apiLock);
};
}  // namespace videocapturemodule
}  // namespace webrtc
#endif  // _OCTK_VIDEO_CAPTURE_MAIN_SOURCE_DEVICE_INFO_IMPL_H_
