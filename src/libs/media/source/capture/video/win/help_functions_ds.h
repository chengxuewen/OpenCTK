...
#ifndef _OCTK_VIDEO_CAPTURE_MAIN_SOURCE_WINDOWS_HELP_FUNCTIONS_DS_H_
#define _OCTK_VIDEO_CAPTURE_MAIN_SOURCE_WINDOWS_HELP_FUNCTIONS_DS_H_
...
// a little less awkward. std::shared_ptr doesn't support the & operator
...
// interfaces.
template <class T>
HRESULT GetComInterface(IUnknown* object, std::shared_ptr<T>* ptr) {
...
#endif  // _OCTK_VIDEO_CAPTURE_MAIN_SOURCE_WINDOWS_HELP_FUNCTIONS_DS_H_
