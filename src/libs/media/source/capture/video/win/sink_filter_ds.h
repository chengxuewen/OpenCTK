...
#ifndef _OCTK_VIDEO_CAPTURE_MAIN_SOURCE_WINDOWS_SINK_FILTER_DS_H_
#define _OCTK_VIDEO_CAPTURE_MAIN_SOURCE_WINDOWS_SINK_FILTER_DS_H_
...
class CaptureInputPin : public IMemInputPin, public IPin {
 ...
 private:
  ...
  VideoCaptureCapability requested_capability_ OCTK_ATTRIBUTE_GUARDED_BY(main_checker_);
  ...
  std::shared_ptr<IMemAllocator> allocator_ OCTK_ATTRIBUTE_GUARDED_BY(main_checker_);
  std::shared_ptr<IPin> receive_pin_ OCTK_ATTRIBUTE_GUARDED_BY(main_checker_);
  ...
  PIN_INFO info_ = {};
  AM_MEDIA_TYPE media_type_ OCTK_ATTRIBUTE_GUARDED_BY(main_checker_) = {};
};
...
class CaptureSinkFilter : public IBaseFilter {
 ...
 private:
  ...
  FILTER_INFO info_ OCTK_ATTRIBUTE_GUARDED_BY(main_checker_) = {};
  ...
  FILTER_STATE state_ OCTK_ATTRIBUTE_GUARDED_BY(main_checker_) = State_Stopped;
};
}  // namespace videocapturemodule
}  // namespace webrtc
#endif  // _OCTK_VIDEO_CAPTURE_MAIN_SOURCE_WINDOWS_SINK_FILTER_DS_H_
