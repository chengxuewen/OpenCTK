...
#ifndef _OCTK_VIDEO_CAPTURE_LINUX_DEVICE_INFO_PIPEWIRE_H_
#define _OCTK_VIDEO_CAPTURE_LINUX_DEVICE_INFO_PIPEWIRE_H_
...
class DeviceInfoPipeWire : public DeviceInfoImpl {
 ...
 private:
  std::shared_ptr<PipeWireSession> pipewire_session_;
};
}  // namespace videocapturemodule
}  // namespace webrtc
#endif  // _OCTK_VIDEO_CAPTURE_LINUX_DEVICE_INFO_PIPEWIRE_H_
