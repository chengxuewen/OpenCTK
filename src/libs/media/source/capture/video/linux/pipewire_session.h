...
#ifndef _OCTK_VIDEO_CAPTURE_LINUX_PIPEWIRE_SESSION_H_
#define _OCTK_VIDEO_CAPTURE_LINUX_PIPEWIRE_SESSION_H_
...
class PipeWireSession : public rtc::RefCountedNonVirtual<PipeWireSession> {
 ...
 private:
  ...
  VideoCaptureOptions::Callback* callback_ OCTK_ATTRIBUTE_GUARDED_BY(&callback_lock_) =
      nullptr;
...
#endif  // _OCTK_VIDEO_CAPTURE_LINUX_PIPEWIRE_SESSION_H_
