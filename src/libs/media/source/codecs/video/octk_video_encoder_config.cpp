...
VideoStream::VideoStream()
    ...
    , max_qp(-1)
    , num_temporal_layers(utils::nullopt)
    , active(true)
{
}
...
std::string VideoEncoderConfig::ToString() const
{
    ...
    switch (content_type)
    {
        case ContentType::kRealtimeVideo: ss << "kRealtimeVideo"; break;
        case ContentType::kScreen: ss << "kScreenshare"; break;
    }
...
void VideoEncoderConfig::EncoderSpecificSettings::FillEncoderSpecificSettings(VideoCodec *codec) const
{
    ...
    {
        OCTK_DCHECK_NOTREACHED() << "Encoder specifics set/used for unknown codec type.";
    }
}

void VideoEncoderConfig::EncoderSpecificSettings::FillVideoCodecVp8(VideoCodecVP8 *vp8_settings) const
{
    OCTK_DCHECK_NOTREACHED();
}

void VideoEncoderConfig::EncoderSpecificSettings::FillVideoCodecVp9(VideoCodecVP9 *vp9_settings) const
{
    OCTK_DCHECK_NOTREACHED();
}
...
VideoEncoderConfig::Vp8EncoderSpecificSettings::Vp8EncoderSpecificSettings(const VideoCodecVP8 &specifics)
    : specifics_(specifics)
{
}

void VideoEncoderConfig::Vp8EncoderSpecificSettings::FillVideoCodecVp8(VideoCodecVP8 *vp8_settings) const
{
    *vp8_settings = specifics_;
}

VideoEncoderConfig::Vp9EncoderSpecificSettings::Vp9EncoderSpecificSettings(const VideoCodecVP9 &specifics)
    : specifics_(specifics)
{
}

void VideoEncoderConfig::Vp9EncoderSpecificSettings::FillVideoCodecVp9(VideoCodecVP9 *vp9_settings) const
{
    *vp9_settings = specifics_;
}

VideoEncoderConfig::Av1EncoderSpecificSettings::Av1EncoderSpecificSettings(const VideoCodecAV1 &specifics)
    : specifics_(specifics)
{
}

void VideoEncoderConfig::Av1EncoderSpecificSettings::FillVideoCodecAv1(VideoCodecAV1 *av1_settings) const
{
