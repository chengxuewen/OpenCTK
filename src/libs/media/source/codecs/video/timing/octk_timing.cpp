...
#include "octk_timing_p.hpp"

#include <algorithm>

#include "api/units/time_delta.h"
#include "octk_decode_time_percentile_filter_p.hpp"
#include "octk_timestamp_extrapolator_p.hpp"
...
void VCMTiming::StopDecodeTimer(TimeDelta decode_time, Timestamp now) {
  ...
  OCTK_DCHECK_GE(decode_time, TimeDelta::Zero());
  ++num_decoded_frames_;
}
...
TimeDelta VCMTiming::EstimatedMaxDecodeTime() const {
  ...
  OCTK_DCHECK_GE(decode_time_ms, 0);
