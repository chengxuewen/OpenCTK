...
public:
    ...
    template <typename T>
    static OCTK_CXX14_CONSTEXPR TestUnit FromKilo(T kilo)
    {
...
OCTK_CXX14_CONSTEXPR TestUnit TestUnitAddKilo(TestUnit value, int add_kilo)
{
...
TEST(UnitBaseTest, ConstExpr)
{
    ...
    OCTK_CXX14_CONSTEXPR_ASSERT(TestUnit::FromValue(0.0).IsZero());
    OCTK_CXX14_CONSTEXPR_ASSERT(TestUnit::FromValue(INFINITY).IsPlusInfinity());
    OCTK_CXX14_CONSTEXPR_ASSERT(TestUnit::FromValue(-INFINITY).IsMinusInfinity());
    OCTK_CXX14_CONSTEXPR_ASSERT(TestUnit::FromValue(250.0) == TestUnit::FromValue(250));
    OCTK_CXX14_CONSTEXPR_ASSERT(TestUnit::FromValue(-250.0) == TestUnit::FromValue(-250));

    static_assert(kTestUnitPlusInf > kTestUnitZero, "");

    OCTK_CXX14_CONSTEXPR TestUnit kTestUnitKilo = TestUnit::FromKilo(kValue);
    OCTK_CXX14_CONSTEXPR TestUnit kTestUnitValue = TestUnit::FromValue(kValue);

    OCTK_CXX14_CONSTEXPR_ASSERT_X(kTestUnitKilo.ToKiloOr(0) == kValue, "");
    OCTK_CXX14_CONSTEXPR_ASSERT_X(kTestUnitValue.ToValueOr(0) == kValue, "");
    OCTK_CXX14_CONSTEXPR_ASSERT_X(TestUnitAddKilo(kTestUnitValue, 2).ToValue() == kValue + 2000, "");
    OCTK_CXX14_CONSTEXPR_ASSERT(TestUnit::FromValue(500) / 2 == TestUnit::FromValue(250));
    OCTK_CXX14_CONSTEXPR_ASSERT(TestUnit::FromValue(500.0) / 2 == TestUnit::FromValue(250.0));
}
