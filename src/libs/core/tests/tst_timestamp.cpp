...
TEST(TimestampTest, ConstExpr)
{
    ...
    OCTK_CXX14_CONSTEXPR Timestamp kTimestampSeconds = Timestamp::Seconds(kValue);
    OCTK_CXX14_CONSTEXPR Timestamp kTimestampMs = Timestamp::Millis(kValue);
    OCTK_CXX14_CONSTEXPR Timestamp kTimestampUs = Timestamp::Micros(kValue);

    OCTK_CXX14_CONSTEXPR_ASSERT(kTimestampSeconds.seconds_or(0) == kValue);
    OCTK_CXX14_CONSTEXPR_ASSERT(kTimestampMs.ms_or(0) == kValue);
    OCTK_CXX14_CONSTEXPR_ASSERT(kTimestampUs.us_or(0) == kValue);

    OCTK_CXX14_CONSTEXPR_ASSERT(kTimestampMs > kTimestampUs);
